...
async def animelogo(_, message):
        ...
        if len(message.command) < 3
            ...
            await message.reply_photo(url,caption="**🖼 Logo Generated By @Nandhabots**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Upload As File 📁", callback_data="alogo")]]))
            await x.delete()    
...
async def flogo(_, query):
    if query.data == "flogo":
          ...
          await x.delete()
            ...
            await query.message.reply_document(file,caption="**🖼 Logo Generated By @NandhaBots**")
            await x.delete()
